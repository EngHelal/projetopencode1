<?php include 'header.php'?>
    ...
    <fieldset class=formulaireInscriotion">
      ...
      <input name="Créer" type="submit" value="Créer mon compte" required></p>
      <input type="checkbox" name="agree" value="">By signing up you agree to our <span><a href="">terms of service.</a></span>
    </fieldset>
    </form>
  </div>
